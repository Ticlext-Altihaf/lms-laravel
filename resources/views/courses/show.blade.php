    ...
    <div class="container">
        <div class="row mb-8">
            <div class="col-lg-8 mb-6 mb-lg-0 position-relative">
                ...
                <p class="me-xl-13 mb-5">Master Figma app to get a job in UI Design, User Interface, User Experience
                    design, Web Design &amp; UX design.</p>
                ...
                <div id="Curriculum" class="mb-8">
                    ...
                    <div id="accordionCurriculum">
                        @foreach($data['lessons_sectioned'] as $section => $lesson)
                                <?php
                ...
                <div id="Reviews" class="mb-8">
                    <ul class="nav course-tab-v1 border-bottom h4 mb-8">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="#Reviews" data-bs-toggle="smooth-scroll"
                               data-bs-offset="0">Reviews</a>
                        </li>
                    </ul>
        ...
        <div class="mx-n4 mb-12 flickity-enabled is-draggable"
            ...
            <div class="flickity-viewport" style="height: 409.766px; touch-action: pan-y;">
                <div class="flickity-slider" style="left: 0px; transform: translateX(-350%);">
                    <div class="col-md-6 col-lg-4 col-xl-3 pb-4 pb-md-5 is-selected"
                         style="padding-right: 15px; padding-left: 15px; position: absolute; left: 350%;">
                        <!-- Card -->
                        <div class="card border shadow-dark-hover p-2 sk-fade">
                            ...
                            <div class="card-zoom position-relative">
                                <a href="./course-single-v5.html" class="card-img sk-thumbnail img-ratio-3 d-block">
                                    <img class="rounded shadow-light-lg" src="{{asset('assets')}}/img/products/product-15.jpg"
                                         alt="...">
                                </a>
                            ...
                            <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                                ...
                                <div class="position-relative">
                                    <a href="./course-single-v5.html" class="d-block stretched-link"><h5
                                            class="line-clamp-2 h-md-48 h-lg-58 me-md-8 me-lg-10 me-xl-4 mb-2">Fashion
                                            Photography From Professional</h5></a>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3 pb-4 pb-md-5"
                         style="padding-right: 15px; padding-left: 15px; position: absolute; left: 400%;"
                         aria-hidden="true">
                        <!-- Card -->
                        <div class="card border shadow-dark-hover p-2 sk-fade">
                            <!-- Image -->
                            <div class="card-zoom position-relative">
                                <a href="./course-single-v5.html" class="card-img sk-thumbnail img-ratio-3 d-block">
                                    <img class="rounded shadow-light-lg" src="{{asset('assets')}}/img/products/product-14.jpg"
                                         alt="...">
                                </a>
                            ...
                            <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                                ...
                                <div class="position-relative">
                                    <a href="./course-single-v5.html" class="d-block stretched-link"><h5
                                            class="line-clamp-2 h-md-48 h-lg-58 me-md-8 me-lg-10 me-xl-4 mb-2">
                                            Productivity and Time Management for workplace</h5></a>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3 pb-4 pb-md-5"
                         style="padding-right: 15px; padding-left: 15px; position: absolute; left: 100%;"
                         aria-hidden="true">
                        <!-- Card -->
                        <div class="card border shadow-dark-hover p-2 sk-fade">
                            <!-- Image -->
                            <div class="card-zoom position-relative">
                                <a href="./course-single-v5.html" class="card-img sk-thumbnail img-ratio-3 d-block">
                                    <img class="rounded shadow-light-lg" src="{{asset('assets')}}/img/products/product-16.jpg"
                                         alt="...">
                                </a>
                            ...
                            <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                                ...
                                <div class="position-relative">
                                    <a href="./course-single-v5.html" class="d-block stretched-link"><h5
                                            class="line-clamp-2 h-md-48 h-lg-58 me-md-8 me-lg-10 me-xl-4 mb-2">Learn
                                            Ethical Hacking From Scratch</h5></a>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3 pb-4 pb-md-5"
                         style="padding-right: 15px; padding-left: 15px; position: absolute; left: 150%;"
                         aria-hidden="true">
                        <!-- Card -->
                        <div class="card border shadow-dark-hover p-2 sk-fade">
                            <!-- Image -->
                            <div class="card-zoom position-relative">
                                <a href="./course-single-v5.html" class="card-img sk-thumbnail img-ratio-3 d-block">
                                    <img class="rounded shadow-light-lg" src="{{asset('assets')}}/img/products/product-12.jpg"
                                         alt="...">
                                </a>
                            ...
                            <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                                ...
                                <div class="position-relative">
                                    <a href="./course-single-v5.html" class="d-block stretched-link"><h5
                                            class="line-clamp-2 h-md-48 h-lg-58 me-md-8 me-lg-10 me-xl-4 mb-2">The
                                            Complete JavaScript Course 2020: Real Projects!</h5></a>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3 pb-4 pb-md-5"
                         style="padding-right: 15px; padding-left: 15px; position: absolute; left: 200%;"
                         aria-hidden="true">
                        <!-- Card -->
                        <div class="card border shadow-dark-hover p-2 sk-fade">
                            <!-- Image -->
                            <div class="card-zoom position-relative">
                                <a href="./course-single-v5.html" class="card-img sk-thumbnail img-ratio-3 d-block">
                                    <img class="rounded shadow-light-lg" src="{{asset('assets')}}/img/products/product-13.jpg"
                                         alt="...">
                                </a>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3 pb-4 pb-md-5"
                         style="padding-right: 15px; padding-left: 15px; position: absolute; left: 250%;"
                         aria-hidden="true">
                        <!-- Card -->
                        <div class="card border shadow-dark-hover p-2 sk-fade">
                            <!-- Image -->
                            <div class="card-zoom position-relative">
                                <a href="./course-single-v5.html" class="card-img sk-thumbnail img-ratio-3 d-block">
                                    <img class="rounded shadow-light-lg" src="{{asset('assets')}}/img/products/product-11.jpg"
                                         alt="...">
                                </a>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3 pb-4 pb-md-5"
                         style="padding-right: 15px; padding-left: 15px; position: absolute; left: 300%;"
                         aria-hidden="true">
                        <!-- Card -->
                        <div class="card border shadow-dark-hover p-2 sk-fade">
                            <!-- Image -->
                            <div class="card-zoom position-relative">
                                <a href="./course-single-v5.html" class="card-img sk-thumbnail img-ratio-3 d-block">
                                    <img class="rounded shadow-light-lg" src="{{asset('assets')}}/img/products/product-10.jpg"
                                         alt="...">
                                </a>
