...
================================================== -->
    ...
    <div class="container mb-6 mb-xl-8 z-index-2">
        <div class="d-xl-flex align-items-center">
            <p class="mb-xl-0">We found <span class="text-dark">{{$data['total']}} courses</span> available for you</p>
                ...
                <div class="ms-xl-auto d-xl-flex flex-wrap">
                    <div class="mb-4 mb-xl-0 ms-xl-6">
                        ...
                        <div class="input-group input-group-filter">
                            <input class="form-control form-control-sm placeholder-dark border-end-0 shadow-none"
                                   type="search" placeholder="Search our courses" aria-label="Search" name="search"
                    ...
                    <div class="mb-4 mb-xl-0 ms-xl-6">
                        <select class="form-select form-select-sm text-dark shadow-none dropdown-menu-end" data-choices
                            ...
                            <option value="all" {{$data['params']['category'] == 'all' ? 'selected' : ''}}>All
                                Categories
                            </option>
                            @foreach($data['available_categories'] as $category)
                                <option
                                    value="{{$category['id']}}" {{$data['params']['category'] == $category['id'] ? 'selected' : ''}}>{{$category['name']}}</option>
                            @endforeach
                ...
                <div class="col-md pb-4 pb-md-7">
                    ...
                    <div class="card border shadow p-2 lift sk-fade">
                        ...
                        <div class="card-zoom position-relative">
                            ...
                            <a href="{{url('courses/'.$course['id'])}}" class="card-img sk-thumbnail d-block">
                                <img class="rounded shadow-light-lg" src="{{$course['image_url']}}" alt="">
                            </a>
                        ...
                        <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                            ...
                            <div class="position-relative">
                                <a href="{{url('courses/'.$course['id'])}}" class="d-block stretched-link"><h4
                                        class="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">{{$course['name']}}</h4>
                                </a>
            ...
            <div class="col-md pb-4 pb-md-7">
                ...
                <div class="card border shadow p-2 lift sk-fade">
                    ...
                    <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        ...
                        <!-- Heading -->
                        <div class="position-relative">
                            <a href="course-single-v2.html" class="d-block stretched-link"><h4
            ...
            <div class="col-md pb-4 pb-md-7">
                ...
                <div class="card border shadow p-2 lift sk-fade">
                    ...
                    <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        ...
                        <div class="position-relative">
                            <a href="course-single-v2.html" class="d-block stretched-link"><h4
                                    class="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">Learn Figma: User
                                    Interface Design Essentials - UI/UX Design</h4></a>
