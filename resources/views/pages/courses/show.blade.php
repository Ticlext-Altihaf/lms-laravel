                ...
                <div class="d-block rounded border p-2 shadow mb-6">
                    ...
                    <div class="pt-5 pb-4 px-5 px-lg-3 px-xl-5">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <del class="ml-3">339.99</del>
                            <div class="badge badge-lg badge-purple text-white ml-auto font-weight-normal">91% Off</div>
                        </div>
                        ...
                        <div class="d-flex align-items-center text-alizarin mb-6">
                            ...
                            <span class="ml-2">2 days left at this price!</span>
                        </div>
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex align-items-center py-3">
                                ...
                                <h6 class="mb-0 ml-3 mr-auto">Duration</h6>
                                <span>43 weeks</span>
                            </li>
                            <li class="list-group-item d-flex align-items-center py-3">
                                <div class="text-secondary d-flex icon-uxs">
                                ...
                                <h6 class="mb-0 ml-3 mr-auto">Lectures</h6>
                                <span>32</span>
                            </li>
                            <li class="list-group-item d-flex align-items-center py-3">
                                <div class="text-secondary d-flex icon-uxs">
                                ...
                                <h6 class="mb-0 ml-3 mr-auto">Enrolled</h6>
                            ...
                            <li class="list-group-item d-flex align-items-center py-3">
                                ...
                                <h6 class="mb-0 ml-3 mr-auto">Language</h6>
                                <span>English</span>
                            </li>
                            <li class="list-group-item d-flex align-items-center py-3">
                                <div class="text-secondary d-flex icon-uxs">
                                ...
                                <h6 class="mb-0 ml-3 mr-auto">Skill level</h6>
                                <span>beginner</span>
                            </li>
                            <li class="list-group-item d-flex align-items-center py-3">
                                <div class="text-secondary d-flex icon-uxs">
                                ...
                                <h6 class="mb-0 ml-3 mr-auto">Deadline</h6>
                            ...
                            <li class="list-group-item d-flex align-items-center py-3">
                                ...
                                <h6 class="mb-0 ml-3 mr-auto">Certificate</h6>
                                <span>Yes</span>
                            </li>
                            <li class="list-group-item d-flex align-items-center py-4">
                                <a href="./course-single-v5.html" class="mx-auto text-teal font-weight-medium d-flex align-items-center mt-2">
                                    <!-- Icon -->
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span class="ml-3">Share this course</span>
                                </a>
                            </li>
                        </ul>
                    </div>
